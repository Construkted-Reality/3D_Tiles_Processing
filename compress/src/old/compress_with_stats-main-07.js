...
//        console.log(`Processed: ${completedTasks - activeProcesses}/${totalFiles}, Remaining: ${remainingFiles}`);
        process.stdout.write(`\rProcessed: ${completedTasks - activeProcesses}/${totalFiles}, Remaining: ${remainingFiles}`);
    }
